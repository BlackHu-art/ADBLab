...
class LiveLogcatForm:
    ...
    def _init_ui(self):
        ...
        reading_row = FlowLayout(self._frame.reading_tools, needAni=False)
        reading_row.setContentsMargins(0, 0, 0, 0)
        reading_row.setHorizontalSpacing(8)
        reading_row.setVerticalSpacing(8)
        ...
        layout.addWidget(self._frame.reading_tools)
        ...
        layout.addWidget(self._frame.reading_status)
    ...
    def _apply_theme(self, _value=None):
        ...
        self._frame.output.setMinimumHeight(
            max(240, self._frame.output.fontMetrics().lineSpacing() * 8 + 26)
        )
