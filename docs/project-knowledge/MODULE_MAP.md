...
| 任务中心 | 展示活动 operation、测试归档及结构化本次操作结果；接收取消意图并桥接部分停止动作 | `gui/pages/tasks_page.py`、`gui/action_feedback.py`、`adblab/application/action_results.py` | `test_task_center.py`、`test_action_results.py`、`test_action_feedback.py` |
