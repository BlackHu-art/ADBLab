...
class Monkey(object):
    ...
    def start_monkey(self, package,timeout):
        ...
        if hasattr(self, '_monkey_running') and self.running == True:
            ...
            return
        self.monkey_cmd = 'monkey -p %s -v -v -v -s 1000000 ' \
                          '--ignore-crashes --ignore-timeouts --ignore-security-exceptions ' \
                          '--kill-process-after-error --pct-appswitch 0 --pct-touch 15 --pct-syskeys 5 ' \
                          '--pct-motion 5 --pct-trackball 0 --pct-majornav 30 --pct-nav 40 --pct-anyevent 5 --pct-flip 0 --pct-pinchzoom 0 ' \
